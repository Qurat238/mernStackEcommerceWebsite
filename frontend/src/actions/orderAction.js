...
export const createOrder = (order) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.post(`${window.location.origin}/api/v1/order/new`,order,config);
...
export const myOrders = () => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.get(`${window.location.origin}/api/v1/orders/me`);
...
export const getAllOrders = () => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.get(`${window.location.origin}/api/v1/admin/orders`);
...
export const updateOrder = (id,order) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`${window.location.origin}/api/v1/admin/order/${id}`,order,config);
...
export const deleteOrder = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.delete(`${window.location.origin}/api/v1/admin/order/${id}`);
...
export const getOrderDetails = (id) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.get(`${window.location.origin}/api/v1/order/${id}`);
