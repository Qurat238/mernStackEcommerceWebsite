...
export const logout = () => async(dispatch) => {
    try {
        await axios.get(`${window.location.origin}/api/v1/logout`);
...
export const forgotPassword = (email) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.post(
            `${window.location.origin}/api/v1/password/forgot`,
            email,
            config
        )
...
export const getAllUsers = () => async(dispatch) => {
    try {
        ...
        const {data} = await axios.get(`${window.location.origin}/api/v1/admin/users`);
...
export const getUserDetails = (id) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.get(`${window.location.origin}/api/v1/admin/user/${id}`);
...
export const updateUser = (id, userData) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.put(
            `${window.location.origin}/api/v1/admin/user/${id}`,
            userData,
            config
        )
...
export const deleteUser = (id) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.delete(`${window.location.origin}/api/v1/admin/user/${id}`)
